        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td width="30%" style="vertical-align: top; padding-top: 10px; position: relative;">
                    <img src="{{ asset('assets/img/livewire-logo.png') }}" class="invoice-logo">
                </td>
        ...
        <table cellpadding="0" cellspacing="0" class="table-items" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center">{{ \Carbon\Carbon::parse($item->created_at)->format('d-m-Y h:m:s')}}</td>
                </tr>
                @endforeach
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td class="text-center" colspan="1">
                        <span>
                            <strong>${{ number_format($data->sum('total'), 2) }}</strong>
                        </span>
                    </td>
                    <td class="text-center">
                        {{ $data->sum('items') }}
